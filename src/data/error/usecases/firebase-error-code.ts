import { FirebaseErrorCode } from '../interface'
...
export namespace FirebaseErrors {
  ...
  export class ClaimsTooLargeError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.CLAIMS_TOO_LARGE,
  ...
  export class IdTokenExpiredError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.ID_TOKEN_EXPIRED,
  ...
  export class IdTokenRevokedError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.ID_TOKEN_REVOKED,
  ...
  export class InsufficientPermissionError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INSUFFICIENT_PERMISSION,
  ...
  export class InvalidClaimsError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_CLAIMS,
  ...
  export class InvalidContinueUriError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_CONTINUE_URI,
  ...
  export class InvalidCreationTimeError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_CREATION_TIME,
  ...
  export class InvalidCredentialError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_CREDENTIAL,
  ...
  export class InvalidDisabledFieldError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_DISABLED_FIELD,
  ...
  export class InvalidDisplayNameError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_DISPLAY_NAME,
  ...
  export class InvalidDynamicLinkDomainError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_DYNAMIC_LINK_DOMAIN,
  ...
  export class InvalidEmailVerifiedError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_EMAIL_VERIFIED,
  ...
  export class InvalidHashAlgorithmError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_HASH_ALGORITHM,
  ...
  export class InvalidHashBlockSizeError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_HASH_BLOCK_SIZE,
  ...
  export class InvalidHashDerivedKeyLengthError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_HASH_DERIVED_KEY_LENGTH,
  ...
  export class InvalidHashKeyError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_HASH_KEY,
  ...
  export class InvalidHashMemoryCostError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_HASH_MEMORY_COST,
  ...
  export class InvalidHashParallelizationError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_HASH_PARALLELIZATION,
  ...
  export class InvalidHashRoundsError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_HASH_ROUNDS,
  ...
  export class InvalidHashSaltSeparatorError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_HASH_SALT_SEPARATOR,
  ...
  export class InvalidIdTokenError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_ID_TOKEN,
  ...
  export class InvalidLastSignInTimeError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_LAST_SIGN_IN_TIME,
  ...
  export class InvalidPageTokenError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_PAGE_TOKEN,
  ...
  export class InvalidPasswordHashError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_PASSWORD_HASH,
  ...
  export class InvalidPasswordSaltError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_PASSWORD_SALT,
  ...
  export class InvalidPhoneNumberError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_PHONE_NUMBER,
  ...
  export class InvalidPhotoUrlError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_PHOTO_URL,
  ...
  export class InvalidProviderDataError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_PROVIDER_DATA,
  ...
  export class InvalidProviderIdError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_PROVIDER_ID,
  ...
  export class InvalidOauthResponsetypeError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_OAUTH_RESPONSETYPE,
  ...
  export class InvalidSessionCookieDurationError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_SESSION_COOKIE_DURATION,
  ...
  export class InvalidUserImportError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.INVALID_USER_IMPORT,
  ...
  export class MaximumUserCountExceededError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.MAXIMUM_USER_COUNT_EXCEEDED,
  ...
  export class MissingAndroidPkgNameError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.MISSING_ANDROID_PKG_NAME,
  ...
  export class MissingContinueUriError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.MISSING_CONTINUE_URI,
  ...
  export class MissingHashAlgorithmError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.MISSING_HASH_ALGORITHM,
  ...
  export class MissingIosBundleIdError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.MISSING_IOS_BUNDLE_ID,
  ...
  export class MissingOauthClientSecretError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.MISSING_OAUTH_CLIENT_SECRET,
  ...
  export class PhoneNumberAlreadyExistsError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.PHONE_NUMBER_ALREADY_EXISTS,
  ...
  export class ProjectNotFoundError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.PROJECT_NOT_FOUND,
  ...
  export class ReservedClaimsError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.RESERVED_CLAIMS,
  ...
  export class SessionCookieExpiredError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.SESSION_COOKIE_EXPIRED,
  ...
  export class SessionCookieRevokedError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.SESSION_COOKIE_REVOKED,
  ...
  export class UidAlreadyExistsError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.UID_ALREADY_EXISTS,
  ...
  export class UnauthorizedContinueUriError extends AuthError {
    constructor() {
      super(
        FirebaseErrorCode.UNAUTHORIZED_CONTINUE_URI,
